...
<div class="content flex items-center justify-center h-screen">
    <div class="bg-white/70 dark:bg-gray-800/70 p-8 rounded-lg shadow-lg w-full max-w-3xl">
        ...
        <div class="grid grid-cols-2 gap-4 mt-6">
            <a href="<c:url value='/home'/>" class="flex items-center gap-4 p-4 bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-50 rounded-lg shadow hover:shadow-md">
