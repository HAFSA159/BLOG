...
('John Doe', 'john.doe@example.com', '$2a$10$Zs8gGTh3AapgHqsIXDZu1O963oYMhOBUSf7z0u8DBXZ6HIb92gd5W', '1985-05-15', 'Contributor'),
('Jane Smith', 'jane.smith@example.com', '$2a$10$Zs8gGTh3AapgHqsIXDZu1O963oYMhOBUSf7z0u8DBXZ6HIb92gd5W', '1990-08-22', 'Editor'),
('Alice Johnson', 'alice.johnson@example.com', '$2a$10$Zs8gGTh3AapgHqsIXDZu1O963oYMhOBUSf7z0u8DBXZ6HIb92gd5W', '1988-03-10', 'Contributor'),
...
('Great article!', '2023-05-02 13:00:00', 'approved', 1, 2),
('I found this very informative.', '2023-05-02 14:30:00', 'approved', 1, 3),
('Looking forward to the full article.', '2023-05-03 10:00:00', 'approved', 2, 1),
('Interesting perspective on tech trends.', '2023-05-05 11:00:00', 'approved', 3, 4);
